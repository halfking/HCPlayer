...
//    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.seenvoice.HCPlayerTest" in the application's documents directory.
...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"HCPlayerTest" withExtension:@"momd"];
