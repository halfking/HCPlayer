...
//    
//    [player play];
//    player.rate = playRate_;
//    
//    NSLog(@"player status:%d",(int)player.status);
//    if(player.error)
//    {
//        //        wantPlay_ = NO;
//        
...
//        
//        NSLog(@"play error:%@",[player.error localizedDescription]);
//        
//        if(self.delegate && [self.delegate respondsToSelector:@selector(playerSimple:didFailWithError:)])
//        {
//            [self.delegate playerSimple:self didFailWithError:player.error];
//        }
//    }
//    else
//    {
