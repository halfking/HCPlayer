...
@optional
- (void)task:(VDCTempFileManagerN *)task didReceiveVideoLength:(long long)ideoLength mimeType:(NSString *)mimeType;
...
@interface VDCTempFileManagerN:NSObject
{
...
@property (nonatomic, weak            ) id <VDCManagerRequestTaskNDelegate> delegate;
